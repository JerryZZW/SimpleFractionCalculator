...
public class SimpleFraction implements SimpleFractionInterface, Comparable<SimpleFraction>
{
	...
	{
            if (den == 0) {
                throw new SimpleFractionException("SimpleFractionException!");
            } else if (den < 0) {//force the denominnator to be postive
                this.num = -num;
                this.den = -den;
            } else {
                this.num = num;
	...
	{
            //Add two fractions
            SimpleFraction f = new SimpleFraction(this.num * ((SimpleFraction)secondFraction).den +
                    this.den * ((SimpleFraction)secondFraction).num, this.den * ((SimpleFraction)secondFraction).den);
                // implement this method!
		// a/b + c/d is (ad + cb)/(bd)
                // return result which is a new SimpleFraction object
            f.reduceSimpleFractionToLowestTerms();//reduce to the lowest term
		return f;
	}	// end add

	public SimpleFractionInterface subtract(SimpleFractionInterface secondFraction)
	{
            //calculte the difference between two fractions
            SimpleFraction f = new SimpleFraction(this.num * ((SimpleFraction)secondFraction).den -
                    this.den * ((SimpleFraction)secondFraction).num, this.den * ((SimpleFraction)secondFraction).den);
                // implement this method!
		// a/b - c/d is (ad - cb)/(bd)
	...
	public SimpleFractionInterface multiply(SimpleFractionInterface secondFraction)
	{
            ...
            SimpleFraction f = new SimpleFraction(this.num * ((SimpleFraction)secondFraction).num, 
            this.den * ((SimpleFraction)secondFraction).den);
                // implement this method!
		// a/b * c/d is (ac)/(bd)
                // return result which is a new SimpleFraction object
            f.reduceSimpleFractionToLowestTerms();//reduce to the lowest term
	...
	public SimpleFractionInterface divide(SimpleFractionInterface secondFraction)
	{
            ...
            SimpleFraction f = new SimpleFraction(this.num * ((SimpleFraction)secondFraction).den, 
            this.den * ((SimpleFraction)secondFraction).num);
                // implement this method!
		// a/b / c/d is (ad)/(bc)
	...
	public SimpleFractionInterface getReciprocal() 
	{
            ...
            SimpleFraction f = new SimpleFraction(this.den, this.num);
                // implement this method!
		// return SimpleFractionException if secondFraction is 0
                // return result which is a new SimpleFraction object
            f.reduceSimpleFractionToLowestTerms();//reduce to the lowest term
	...
	{
            //check the equality of two fractions
            this.reduceSimpleFractionToLowestTerms();//reduce to the lowest term
            ((SimpleFraction)other).reduceSimpleFractionToLowestTerms();//reduce to the lowest term
            if (this.num == ((SimpleFraction)other).num && this.den == ((SimpleFraction)other).den) {
                return true;
            } else {
                // implement this method!
                return false;
	...
	{
            //calculate the lowest term of a fraction
            int gcd;
            if (this.num < 0) {//get the greatest common divisor
